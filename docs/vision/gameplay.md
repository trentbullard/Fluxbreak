...
- Story Run Seed: The initial story-mode structure should support a short authored run with at least two distinct stages, where stage one resolves through a boss-spawned gateway and stage two can complete the run.
